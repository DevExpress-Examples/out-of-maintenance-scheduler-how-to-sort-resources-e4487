...
Namespace DevExpressMvcApplication1.Views
	Public Class HomeController
		...
		Public Function SchedulerPartial() As ActionResult
			ViewBag.ResourcesSortType = If((Request.Params("ResourcesSortType") IsNot Nothing), Integer.Parse(Request.Params("ResourcesSortType")), CInt(Fix(ResourcesSortOrder.None)))
